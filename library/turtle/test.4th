...
: polygon times 2dup edge loop 2drop ;
: slices 360 over / swap ;
: spin slices times 2dup turn call loop 2drop ;
...
: burst begin 60 times i 6 * head 0 0 go 80 move loop show ;

: squaril begin -70 -35 go 20 times 140 move 126 turn loop show ;
...
: rose begin 0 54 times 2 + dup move 84 turn loop show ;
